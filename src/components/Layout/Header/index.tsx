...
const Header: React.FC = () => {
  ...
  return (
    <header
      className={`fixed top-0 z-40 w-full transition-all duration-300 ${sticky ? " shadow-lg bg-bodyBg bg-banner-image py-0" : "shadow-none py-8"
        }`}
    >
          ...
          <div className="flex items-center gap-4">
            ...
            {isSignUpOpen && (
              <div className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 flex items-center justify-center z-50">
                <div
                  ref={signUpRef}
                  className="relative mx-auto w-full max-w-md overflow-hidden rounded-lg bg-simple-bg backdrop-blur-md px-8 pt-14 pb-8 text-center"
                >
                  <button
