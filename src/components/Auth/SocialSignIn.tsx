    ...
    <>
      <div className="flex gap-4">
        <button
          ...
          className="flex w-full items-center justify-center gap-2.5 rounded-lg p-3.5 hover:bg-slateGray bg-gradient-to-r from-primary/60 to-secondary/60 hover:from-primary hover:to-secondary text-white"
        >
          Sign In
          <svg
            width="23"
